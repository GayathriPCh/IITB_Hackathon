...
<div className="sp">
  ...
  <button className="sparkle-button"onClick={() => navigate('/book-ticket')}>
    ...
    <span className="text">Book your tickets now!</span>
  </button>
...
<p className="heading">Each ticket is a unique NFT on the blockchain, eliminating counterfeiting and fraud</p>
...
<p className="heading">Keep all your flight tickets as digital collectibles in your wallet</p>
<div className="categories">
...
<p className="heading">Safely resell or transfer your tickets through our verified marketplace</p>
<div className="categories">
